  ...
  if (!patientData) {
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: '#f5f5f5', justifyContent: 'center', alignItems: 'center' }}>
        ...
        <Text style={{ color: '#666', fontSize: 18, marginTop: 16 }}>Patient not found</Text>
      </SafeAreaView>
    );
  }
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#f5f5f5' }}>
      ...
      <View style={{ backgroundColor: '#fff', paddingHorizontal: 16, paddingVertical: 16, borderBottomWidth: 1, borderBottomColor: '#E5E7EB' }}>
        ...
        <View style={{ flexDirection: 'row', marginTop: 16, gap: 12 }}>
          <View style={{ flex: 1, backgroundColor: '#F3F4F6', padding: 12, borderRadius: 8, alignItems: 'center' }}>
            ...
            <View style={{ backgroundColor: '#fff', borderRadius: 12, padding: 16, marginBottom: 16 }}>
              ...
              <View style={{ gap: 8 }}>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  ...
                  <Text style={{ marginLeft: 8, color: '#374151' }}>{patient.phone}</Text>
                </View>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <Ionicons name="mail-outline" size={16} color="#6B7280" />
                  <Text style={{ marginLeft: 8, color: '#374151' }}>{patient.email}</Text>
                </View>
                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                  <Ionicons name="location-outline" size={16} color="#6B7280" />
                  <Text style={{ marginLeft: 8, color: '#374151' }}>{patient.location}</Text>
                </View>
              </View>
            </View>
                ...
                >
                  ...
                  <View style={{ gap: 4 }}>
                    {prescription.medications.map((med, index) => (
                      <Text key={index} style={{ fontSize: 14, color: '#374151' }}>
