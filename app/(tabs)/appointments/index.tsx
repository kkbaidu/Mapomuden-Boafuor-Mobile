...
export default function AppointmentsScreen() {
  ...
  return (
    <View className="flex-1 bg-gray-50">
        ...
        {filteredAppointments.length === 0 ? (
          ...
          <View className="py-4 space-y-4">
            {filteredAppointments.map((appointment) => (
              <TouchableOpacity
                key={appointment._id}
                onPress={() => router.push({ pathname: '/appointments/details/[id]', params: { id: appointment._id } })}
      ...
      <TouchableOpacity
        onPress={() => router.push('/appointments/book')}
        className="absolute bottom-6 right-6 bg-gradient-to-r from-blue-600 to-green-500 w-14 h-14 rounded-full shadow-lg items-center justify-center"
        style={{
          shadowColor: '#2563EB',
